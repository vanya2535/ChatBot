    ...
    'intents': {
        'hello': {
            'examples': ['Привет', 'Здравствуй', 'Здравствуйте', 'Здарова', 'Приветик', 'Хай', 'добрый день',
                         ...
                         'доброго утра', 'доброго дня', 'приветствую!', 'добрый вечер', 'хэлоу', 'здравствуй'],
        ...
        'how are you': {
            'examples': ['Как дела?', 'Как твои дела?', 'Как сам?', 'Как ты себя чувствуешь?', 'Как у тебя дела?',
                         ...
                         'что чувствуешь', 'че-как', 'как жизнь', 'что по настрою', 'как поживаешь', 'как делишки'],
        ...
        'who are you': {
            'examples': ['Ты кто?', 'Кто ты?', 'Кто ты такой?', 'Что ты такое?', 'с кем я говорю', 'как твоё имя',
                         ...
                         'как тебя величать', 'что ты такое', 'кто такой', 'как я могу к тебе обращаться',
                         'как твое имя', 'звать тебя как', 'как зовут'],
